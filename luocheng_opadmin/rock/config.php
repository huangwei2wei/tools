...
$MONGO["servers"][$i]["mongo_host"] = "192.168.1.11";//mongo host
$MONGO["servers"][$i]["mongo_port"] = "8000";//mongo port
...
$MONGO["servers"][$i]["mongo_name"] = "外网测试";
$MONGO["servers"][$i]["mongo_host"] = "114.67.62.10";
$MONGO["servers"][$i]["mongo_port"] = "8000";
