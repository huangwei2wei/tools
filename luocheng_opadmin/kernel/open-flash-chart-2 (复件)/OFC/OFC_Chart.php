...
require_once(D_R.'kernel/open-flash-chart-2/OFC/Charts/Pie/OFC_Charts_Pie.php');
require_once(D_R.'kernel/open-flash-chart-2/OFC/Charts/Pie/OFC_Charts_Pie_1.php');
